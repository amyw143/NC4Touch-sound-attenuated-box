...
cfg.baselineDir  = fullfile(projectRoot, 'data_march', 'baseline');
...
cfg.baselineMean    = 69.40;         % dB SPL — from baseline recording
cfg.endBuffer_s     = 0.4;           % seconds trimmed from end of event windows
